...
st.set_page_config(page_title="GSC-X Industrial Sandbox", layout="wide")
...
st.sidebar.title("GSC-X Industrial Controls")
...
st.markdown('<div class="big-title">GSC-X v9.1 INDUSTRIAL SANDBOX 🏭 🏥 ✈️ 📡 🚀</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Autonomous Industrial Stability Platform</div>', unsafe_allow_html=True)

st.markdown("""
<div style="font-size:20px; line-height:1.6; padding-top:8px; padding-bottom:18px;">
<b>GSC-X</b> is a multi-domain nonlinear stability architecture applicable across the full spectrum of modern industry — including energy systems, heavy industry, aerospace, telecommunications, autonomous infrastructure, transportation, and future deep-space missions.
</div>
""", unsafe_allow_html=True)
...
c3.metric("PRODUCTIVITY / ENERGY", "353.0")
c4.metric("PID BASELINE", "FAILED")
st.markdown("---")

st.subheader("Validated Industrial Benchmark Results (TRUE N3000)")
bench = pd.DataFrame({
