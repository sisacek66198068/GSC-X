...
def main():
    ...
    df.to_csv("fusion_core_gscx_v91_results.csv", index=False)
    ...
    summary.to_csv("fusion_core_gscx_v91_summary.csv", index=False)
    ...
    for metric in [
        ...
        plt.tight_layout()
        plt.savefig(f"fusion_core_gscx_v91_{metric}.png", dpi=180)
        plt.close()

    print("\nSAVED:")
    print("  fusion_core_gscx_v91_results.csv")
    print("  fusion_core_gscx_v91_summary.csv")
    print("  fusion_core_gscx_v91_*.png")
